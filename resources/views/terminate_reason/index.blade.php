...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Terminate Reason</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('dashboard.index')}}">Beranda</a></li>
            <li class="breadcrumb-item active">Terminate Reason</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Create New Terminate Reason</h4>
...
<div class="modal fade in" id="modalEdit" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Edit Terminate Reason
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade in" id="modalDelete" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Delete Terminate Reason</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
    ...
    $(document).ready(function(){
        ...
        $('.btn-add').click(function(){
            ...
            $('#form-create').submit(function(e){
                ...
                $.ajax({
                    url:"{{route('terminate_reason.create')}}",
                    type:'POST',
                    data:formData,
                    processData: false,
                    contentType: false,
        ...
        $('.btn-edit').click(function(){
            ...
            $.ajax({
                url:"{{route('terminate_reason.edit')}}",
                type:'POST',
                data:{
                  id:btnID,
                },
                ...
                error:function(response){
                    $('#errorNameEdit').text(response.responseJSON.errors.name);
                }
            ...
            $('#form-edit').submit(function(e){
                ...
                var formData = new FormData(this);
                $.ajax({
                    url:"{{route('terminate_reason.update')}}",
                    type:'POST',
                    data:{
                      id:ID,
        ...
        $('.btn-delete').click(function(){
          ...
          $('#form-delete').submit(function(e){
                ...
                $.ajax({
                    url:"{{route('terminate_reason.delete')}}",
                    type:'POST',
                    data:{
                      id:ID,
                    },
